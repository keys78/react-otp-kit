...
const CustomInputStylesPage = () => {
  ...
  const description = (
    <div>
      ...
      <ul>
        <li>
          <code>generalStyles</code>: CSS classes to style the general state of
          the input fields. Options include:
          <div>
            <span>
      ...
      <br />
      <p>
        You can also style your input fields based on your preferences. You can
        use regular CSS, SCSS, or Tailwind CSS for your styles.
      </p>
      <br />
