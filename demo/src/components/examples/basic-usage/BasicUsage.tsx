...
import TemplateBasic, { basicUsageTemp } from "./Template";
...
const BasicUsage = () => {
  ...
  const handleCopyClick = () => {
    navigator.clipboard.writeText(basicUsageTemp);
    setShowCheck(true);
    setTimeout(() => {
      setShowCheck(false);
    }, 2000);
  ...
  return (
    <section id="basicusage" className="w-[900px]">
      <h1>{"Examples11111"}</h1>
      <div className="p-4">
        <Tabs
          tabs={[
